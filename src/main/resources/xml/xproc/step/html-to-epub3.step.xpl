...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:px="http://www.daisy.org/ns/pipeline/xproc" xmlns:d="http://www.daisy.org/ns/pipeline/data"
    ...
    <p:choose name="choose">
        ...
        <p:when test="/*/@result='ok' or $fail-on-error = 'false'">
            ...
            <p:add-attribute match="/*" attribute-name="prefix" attribute-value="nordic: http://www.mtm.se/epub/ schema: http://www.schema.org/" name="html-to-epub3.step.add-opf-attribute.nordic-prefix"/>
